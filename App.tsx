...
const INITIAL_MESSAGE: ChatMessage = {
  role: 'model',
  content: 'Halo! Saya Senior Architect Bisa Coding. Saya siap membantu Anda melakukan audit kode, debugging, atau merancang arsitektur sistem yang kompleks. Silakan tempel kode Anda atau lampirkan file yang ingin dianalisis.',
  timestamp: Date.now()
};
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-900 pb-10">
                <div className="space-y-2">
                  <h2 className="text-4xl font-black text-white flex items-center gap-4">
                    <div className="w-4 h-12 bg-blue-600 rounded-full shadow-[0_0_20px_rgba(37,99,235,0.3)]"></div>
                    Workspace Utama
                  </h2>
